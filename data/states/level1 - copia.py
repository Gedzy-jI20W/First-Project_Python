...
class Level1(tools._State):
    ...
    def setup_bricks(self):
        ...
        brick4  = bricks.Brick(3256, 365, c.SIXCOINS, self.coin_group)
        brick5  = bricks.Brick(3299, 365)
        brick6  = bricks.Brick(3342, 193)
        brick7  = bricks.Brick(3386, 193)
        brick8  = bricks.Brick(3430, 193)
        brick9 = bricks.Brick(3473, 193)
        brick10 = bricks.Brick(3516, 193)
        brick11 = bricks.Brick(3559, 193)
        brick12 = bricks.Brick(3602, 193)
        brick13 = bricks.Brick(3645, 193)
        brick14 = bricks.Brick(3901, 193)
        brick15 = bricks.Brick(3944, 193)
        brick16 = bricks.Brick(4030, 365, c.SIXCOINS, self.coin_group)
        brick17 = bricks.Brick(4287, 365)
        brick18 = bricks.Brick(4330, 365, c.STAR, self.powerup_group)
        brick19 = bricks.Brick(4373, 365)
        brick20 = bricks.Brick(4502, 322) 
        brick21 = bricks.Brick(4588, 365)
        brick22 = bricks.Brick(4631, 365)
        brick23 = bricks.Brick(4717, 365)
        brick24 = bricks.Brick(4760, 365)
        brick25 = bricks.Brick(4846, 322)
        brick26 = bricks.Brick(5058, 365)
        brick27 = bricks.Brick(5120, 302)
        brick28 = bricks.Brick(5187, 193)
        brick29 = bricks.Brick(5230, 193)
        brick30 = bricks.Brick(5380, 286)
        brick31 = bricks.Brick(5273, 193)
        brick32 = bricks.Brick(5488, 193)
        brick33 = bricks.Brick(5574, 193)
        brick34 = bricks.Brick(5617, 193)
        brick35 = bricks.Brick(5531, 365)
        brick36 = bricks.Brick(5574, 365)
        brick37 = bricks.Brick(7202, 365)
        brick38 = bricks.Brick(7245, 365)
        brick39 = bricks.Brick(7331, 365)
