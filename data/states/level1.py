...
class Level1(tools._State):
    ...
    def setup_bricks(self):
        ...
        brick4  = bricks.Brick(3376, 365)
        brick5  = bricks.Brick(3419, 365, c.SIXCOINS, self.coin_group)
        brick6  = bricks.Brick(3299, 193)
        brick7  = bricks.Brick(3342, 193)
        brick8  = bricks.Brick(3386, 193)
        brick9  = bricks.Brick(3430, 193)
        brick10 = bricks.Brick(3473, 193)
        brick11 = bricks.Brick(3516, 193)
        brick12 = bricks.Brick(3559, 193)
        brick13 = bricks.Brick(3602, 193)
        brick14 = bricks.Brick(3645, 193)
        brick15 = bricks.Brick(3901, 193)
        brick16 = bricks.Brick(3944, 193)
        ...
        brick20 = bricks.Brick(4373, 365)
        brick21 = bricks.Brick(4588, 365)
        brick22 = bricks.Brick(4631, 365)
        brick23 = bricks.Brick(4717, 365)
        brick24 = bricks.Brick(4760, 365)
        brick25 = bricks.Brick(5058, 365)
        brick26 = bricks.Brick(5120, 302)
        brick27 = bricks.Brick(5187, 193)
        brick28 = bricks.Brick(5230, 193)
        brick29 = bricks.Brick(5380, 286)
        brick30 = bricks.Brick(5273, 193)
        brick31 = bricks.Brick(5488, 193)
        brick32 = bricks.Brick(5574, 193)
        brick33 = bricks.Brick(5617, 193)
        brick34 = bricks.Brick(5531, 365)
        brick35 = bricks.Brick(5574, 365)
        brick36 = bricks.Brick(7202, 365)
        brick37 = bricks.Brick(7245, 365)
        brick38 = bricks.Brick(7331, 365)
    ...
    def setup_coin_boxes(self):
        ...
        coin_box5  = coin_box.Coin_box(3462, 365, c.MUSHROOM, self.powerup_group)
    ...
    def setup_enemies(self):
        ...
        enemy_group7 = pg.sprite.Group(goomba8)
        enemy_group8 = pg.sprite.Group(koopa1)
        enemy_group9 = pg.sprite.Group(goomba9)
        enemy_group10 = pg.sprite.Group(koopa2, koopa3)
        enemy_group11 = pg.sprite.Group(koopa4)
    ...
    def delete_if_off_screen(self, enemy):
        ...
        if enemy.rect.x < (self.viewport.x - 300):
            ...
            if enemy.rect.x > (self.viewport.right + 402):
                enemy.kill()
    ...
    def end_game(self):
        ...
        elif (self.current_time - self.flag_timer) > 4002:
            self.set_game_info_values()
            self.next = c.GAME_OVER
