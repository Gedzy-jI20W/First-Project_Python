...
class Enemy(pg.sprite.Sprite):
    ...
    def walking(self):
        ...
        if (self.current_time - self.animate_timer) > 375:
...
class Goomba(Enemy):
    ...
    def setup_frames(self):
        ...
        self.frames.append(
            self.get_image(323, 212, 21, 32))
        self.frames.append(
            self.get_image(348, 212, 21, 33))
        self.frames.append(
            self.get_image(368, 212, 30, 35))
...
class Koopa(Enemy):
    ...
    def setup_frames(self):
        """Sets frame list"""
        self.frames.append(
            self.get_image(316, 1, 57, 40))
        self.frames.append(
            self.get_image(250, 0, 55, 40))
        self.frames.append(
            self.get_image(142, 0, 53, 35))
        self.frames.append(
            self.get_image(194, 0, 56, 36))
        self.frames.append(pg.transform.flip(self.frames[3], False, True))
