...
class Score(object):
    ...
    def create_image_dict(self):
        ...
        image0 = self.get_image(7, 169, 6, 6)
        image1 = self.get_image(1, 169, 5, 6)
        image2 = self.get_image(14, 169, 5, 6)
        image4 = self.get_image(7, 169, 6, 6)
        image5 = self.get_image(1, 169, 19, 6)
        image8 = self.get_image(1, 169, 19, 6)
        image9 = self.get_image(1, 169, 19, 6)
        image10 = self.get_image(1, 169, 19, 6)
        image11 = self.get_image(1, 169, 19, 6)
