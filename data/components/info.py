...
class OverheadInfo(object):
    ...
    def create_image_dict(self):
        ...
        character_string = '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ -*x'
    ...
    def create_info_labels(self):
        ...
        self.create_label(self.mario_label, 'DANIEL', 75, 30)
        self.create_label(self.world_label, 'MONEDAS', 300, 30)
        self.create_label(self.time_label, 'TIEMPO', 625, 30)
        self.create_label(self.stage_label, 'ALV', 502, 30)
    ...
    def create_load_screen_labels(self):
        ...
        self.create_label(number_label, '1-1', 436, 200)
    ...
    def create_game_over_label(self):
        ...
        self.create_label(game_label, 'BY DANIEL', 200, 300)
        self.create_label(over_label, 'IZABA XD', 462, 300)
    ...
    def create_time_out_label(self):
        ...
        self.create_label(time_out_label, 'YA NO PUDE LLEGARLE', 164, 310)
    ...
    def create_main_menu_labels(self):
        ...
        self.create_label(player_one_game, '1 DANIEL GAME', 272, 360)
        self.create_label(player_two_game, '2 COMO IO NO HAY', 272, 405)
