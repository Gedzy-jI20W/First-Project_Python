...
class Coin(pg.sprite.Sprite):
    ...
    def setup_frames(self):
        ...
        self.frames.append(self.get_image(177, 97, 14, 16))
        self.frames.append(self.get_image(149, 113, 6, 14))
        self.frames.append(self.get_image(163, 113, 10, 15))
        self.frames.append(self.get_image(181, 113, 6, 15))
